...
public class Response<T> implements Serializable {
    ...
    public boolean isValid() {
        return StrUtil.isNotEmpty(this.errorCode) || StrUtil.isNotEmpty(this.errorCode);
    }

    public static <T> com.chat.utils.aptos.request.v1.model.Response<T> from(Response response, Class<T> clazz) {
    ...
    public static <T> com.chat.utils.aptos.request.v1.model.Response<T> from(T data) {
