package com.chat.utils.agora.sample;

import com.chat.utils.agora.media.DynamicKey5;
...
public class Verifier5 {
    public static void main(String[] args) throws Exception {
        if (args.length < 5) {
            System.out.println("java com.chat.utils.agora.media.sample.Verifier5 appID appCertificate channelName uid channelKey");
            return;
        }
